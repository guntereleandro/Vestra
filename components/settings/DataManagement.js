...
export default function DataManagement() {
  ...
  function exportData() {
    try {
      ...
      link.href = url; link.download = `${brandConfig.backupFilePrefix}-${new Date().toISOString().slice(0, 10)}.json`; link.click();
