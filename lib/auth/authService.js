...
import { ensureCurrentRemoteProfile } from "../services/accountCoreService.js";
...
export async function signInWithPassword(input) {
  ...
  return runAuthOperation(async () => {
    ...
    if (error) throw error;
    await ensureCurrentRemoteProfile(data.user);
...
export async function signOut() {
  return runAuthOperation(async () => {
    ...
    if (error) throw error;
    const { resetDataSourceRuntime } = await import("../services/dataSourceResolver.js");
