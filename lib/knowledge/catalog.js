...
export const tutorials = [
  ...
  article("tutorial-conta", "conta-e-acesso", "tutorials", "Conta e acesso", "Crie uma conta, confirme o e-mail e gerencie sua sessão.", ["Use Cadastro para criar uma conta com e-mail e senha e confirme o endereço pelo link recebido.", "A área Conta mostra somente o e-mail, a confirmação e a data básica do último acesso.", "Esqueci minha senha inicia um fluxo seguro de recuperação.", "Sua conta não sincroniza nem envia a carteira nesta fase; operações, preferências e snapshots continuam neste navegador.", "Sair encerra a sessão, mas não apaga seus dados locais."], ["conta", "login", "senha", "dados locais"]),
];
...
export const faq = [article("faq-areas", "areas-atuais", "faq", "Perguntas frequentes", "Respostas rápidas sobre as áreas atuais.", [
  ...
  "Criar uma conta envia minha carteira? Não. A conta autentica o acesso, mas os dados financeiros continuam locais nesta fase.",
