...
export function validateBackup(value) {
  ...
  return { operations: normalizeOperations(value.operations), assetsMaster, quotes: normalizeQuotes(value.quotes, assetsMaster), portfolioHistory: normalizePortfolioHistory(value.portfolioHistory), diagnosticPreferences: preferencesValidation.value, riskProfile: riskValidation.value };
}
