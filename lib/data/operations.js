...
export function isPassiveIncomeOperation(operation) { return isIncomeOperation(operation?.operationType) && !["Caixa Remunerado", "Renda Fixa"].includes(operation?.assetType); }
