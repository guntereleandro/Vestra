export const ASSET_TYPES = ["Ação", "Ação/Unit", "FII", "ETF", "BDR", "Cripto", "Renda Fixa", "Caixa", "Caixa Remunerado", "Outros"];
...
export const INITIAL_ASSETS = [
  ...
  { ticker: "WEGE3", name: "WEG S.A.", shortName: "WEG", type: "Ação", sector: "Bens Industriais", segment: "Motores, Compressores e Outros", exchange: "B3", isin: "BRWEGEACNOR0" },
...
export function normalizeAssetRecord(asset = {}) {
  ...
  return {
    ...
    indicators: asset.indicators && typeof asset.indicators === "object" ? asset.indicators : undefined,
    dividends: Array.isArray(asset.dividends) ? asset.dividends : undefined,
    providerLimitations: Array.isArray(asset.providerLimitations) ? asset.providerLimitations : [],
    quote: asset.quote && typeof asset.quote === "object" ? asset.quote : undefined,
  };
}
