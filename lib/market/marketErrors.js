...
export function userMarketMessage(code) {
  const messages = {
    ...
    [MARKET_ERRORS.PROVIDER_PERMISSION]: "Indicadores indisponiveis no provedor atual.",
    [MARKET_ERRORS.INVALID_TOKEN]: "O token do provedor de mercado nao foi aceito.",
  };
