...
Artigos oficiais: Dashboard, Carteira, Operações, Mercado, Objetivos, Diagnósticos, Performance, Perfil, Estratégia e Backup. Os metadados canônicos estão em `knowledge/metadata.json`.
